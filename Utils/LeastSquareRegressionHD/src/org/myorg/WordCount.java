...
public class WordCount extends Configured implements Tool {
    ...
    public static class Map extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text> {
        ...
        private int klines = 100;
        private int maxTime = 260010;
        ...
        public void map(LongWritable key, Text value, OutputCollector<Text, Text> output, Reporter reporter) throws IOException {
            ...
            double time = d_atts[0];

            ///
            int time_t = 250010;

            int timeInterval = maxTime / klines;
            System.out.println("time interval: " + timeInterval);

            int t_interval = time_t / timeInterval;
            System.out.println("t_interval: " + t_interval);

            ///
            Text outputValue = new Text(line);
            Text outputKey = new Text(String.valueOf(t_interval));
