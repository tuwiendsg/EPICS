...
public class Sensor25 {
    ...
    String uri="http://windtunnel.com#";
     ...
     // sensorResource.addProperty(RDFS.member, moduleResource);
      ...
      Property locationProperty=model.createProperty(uri+"locationSensor25");
      sensorResource.addProperty(locationProperty, "P4*B1*S1");
      ...
      sensorResource.addProperty(sile, "1");*/
