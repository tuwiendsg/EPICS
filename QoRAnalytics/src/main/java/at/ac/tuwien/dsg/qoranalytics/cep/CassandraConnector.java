...
package at.ac.tuwien.dsg.qoranalytics.cep;
     ...
     // delete the keyspace
      ...
      public void deleteRow(String keyspace, String table, String condition)
      {
          try
          {
            ...
            System.out.println("Delete the entire row of "+condition);
          }
          catch(Exception e)
          {
              System.out.println("does not exist");
      ...
      public void deleteAllColumn(String keyspace, String table, String column)
      {
          try
          {
            session.execute("ALTER TABLE "+keyspace+"."+table+" DROP "+column);
             System.out.println(column+" is deleted from entire table "+keyspace+"."+table);
          }
          catch(Exception e)
          {
              System.out.println("does not exist");
      ...
      public void addColumn(String keyspace, String table, String column, String columnDataType)
      {
          try
          {
              ...
              System.out.println(column+" is added in the table "+keyspace+"."+table);
          }
          catch(Exception e)
          {
              System.out.println("does not exist");
