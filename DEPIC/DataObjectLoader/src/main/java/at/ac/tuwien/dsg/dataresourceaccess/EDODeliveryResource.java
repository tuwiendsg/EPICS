 ...
 */
@Path("EDODelivery")
public class EDODeliveryResource {

    @Context
    private UriInfo context;

    /**
     * Creates a new instance of EDODeliveryResource
     */
    public EDODeliveryResource() {
    }

    /**
     * Retrieves representation of an instance of at.ac.tuwien.dsg.dataresourceaccess.EDODeliveryResource
    ...
    /**
     * PUT method for updating or creating an instance of EDODeliveryResource
    ...
    public void putXml(String content) {
        ...
        eDODeliveryAccessManagement.save2DeliveryEDORepo(eDORepo);
