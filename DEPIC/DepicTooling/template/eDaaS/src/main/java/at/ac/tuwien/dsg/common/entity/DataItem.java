...
public class DataItem {
    ...
    public DataItem(String id, Date dateTime, double global_active_power, double global_reactive_power, double voltage, double global_intensity, double sub_metering_1, double sub_metering_2, double sub_metering_3) {
        this.id = id;
    ...
    @XmlElement (name ="global_active_power")
    ...
    @XmlElement (name ="global_reactive_power")
    ...
    @XmlElement (name ="global_intensity")
    ...
    @XmlElement (name ="sub_metering_1")
    ...
    @XmlElement (name ="sub_metering_2")
    ...
    @XmlElement (name ="sub_metering_3")
