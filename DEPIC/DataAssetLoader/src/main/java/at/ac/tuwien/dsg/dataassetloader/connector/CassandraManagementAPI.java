 ...
 */
package at.ac.tuwien.dsg.dataassetloader.connector;

//import at.ac.tuwien.dsg.daas.DataManagementAPIFactory;


import at.ac.tuwien.dsg.dataassetloader.connector.entities.Column;
...
import at.ac.tuwien.dsg.dataassetloader.connector.entities.TableQuery;
 ...
 */
//@Component
public class CassandraManagementAPI  {
...
//    @Value("${CassandraNode.PORT:9042}")
    ...
    public void createKeyspace(Keyspace keyspace) throws FileNotFoundException {
