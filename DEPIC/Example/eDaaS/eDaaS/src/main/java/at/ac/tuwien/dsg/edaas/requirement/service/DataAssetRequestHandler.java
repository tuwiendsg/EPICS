...
public class DataAssetRequestHandler {
    ...
    public DataAsset processDataAssetRequest(DataAssetRequest dataAssetRequest){
        ...
        String expectedElasticStates = findExpectedElasticState(dataAssetRequest);
        
        startMonitoringServices(expectedElasticStates);
    ...
    public String findExpectedElasticState(DataAssetRequest dataAssetRequest){
        ...
        String expectedEStates = "";
        
        for (String eStateID : expectedElasticStateIDs){
            expectedEStates = expectedEStates + eStateID + ";";
        }
        
        return expectedEStates;
        
        
    }
    
    
    public void startMonitoringServices(String expectedElasticStates){
        Configuration configuration  = new Configuration();
        ...
        RestfulWSClient ws = new RestfulWSClient(ip, port, resource);
        ws.callPutMethod(expectedElasticStates);
    }
