...
public class SYBLRestWS {
    ...
    public void submitDataElasticityRequirement(String xmlString) throws IOException {

        String url = "http://"+ip+":"+port+"/sSYBL/webresources/elReq";
