...
// * @author Jun
// */
//public class SampleData_DaaS_KDD_8 {
//      
//    
...
//         // arcQuery metric
//        
//        Range query1 = new Range("query1", 0,90);
//        Range query2 = new Range("query2", 91,95);
//        Range query3 = new Range("query3", 96,100);
//     
//        List<Range> listOfRanges_query = new ArrayList<Range>();
//        listOfRanges_query.add(query1);
//        listOfRanges_query.add(query2);
//        listOfRanges_query.add(query3);
//
//        String name_query = "arcQuery";
//        String unit_query = "%";
//        
//        QoRMetric metric_query = new QoRMetric(name_query, unit_query, listOfRanges_query);
//        listOfQoRMetrics.add(metric_query);
//        
//        
//        // arcTitle metric
//        Range title1 = new Range("title1", 0,90);
//        Range title2 = new Range("title2", 91,95);
//        Range title3 = new Range("title3", 96,100);
//     
//        List<Range> listOfRanges_title = new ArrayList<Range>();
//        listOfRanges_title.add(title1);
//        listOfRanges_title.add(title2);
//        listOfRanges_title.add(title3);
//
//        String name_title = "arcTitle";
//        String unit_title = "%";
//        
//        QoRMetric metric_title = new QoRMetric(name_title, unit_title, listOfRanges_title);
//        listOfQoRMetrics.add(metric_title);
//        
//        
//        // arcKeyword
//        Range keyword1 = new Range("keyword1", 0,90);
//        Range keyword2 = new Range("keyword2", 91,95);
//        Range keyword3 = new Range("keyword3", 96,100);
//     
//        List<Range> listOfRanges_keyword = new ArrayList<Range>();
//        listOfRanges_keyword.add(keyword1);
//        listOfRanges_keyword.add(keyword2);
//        listOfRanges_keyword.add(keyword3);
//
//        String name_keyword = "arcKeyword";
//        String unit_keyword = "%";
//        
//        QoRMetric metric_keyword = new QoRMetric(name_keyword, unit_keyword, listOfRanges_keyword);
//        listOfQoRMetrics.add(metric_keyword);
//        
//        
//        
//        
