 ...
 * @author Jun
 */
public class PrimitiveActionRepositoryGenerator_3 {

    public PrimitiveActionRepositoryGenerator_3() {
    }
...
//        listOfAnalyticTasks.add(kmeansTask);
 ...
 //       MetricCondition c2 = new MetricCondition(associatedQoRMetric, "c2", 76, 90);
        ...
        AdjustmentCase transition1 = new AdjustmentCase( null, null, listOfParameters);
