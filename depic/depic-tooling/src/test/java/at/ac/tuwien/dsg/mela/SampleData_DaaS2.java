...
//        Range di1 = new Range("di1",0,0);
//        Range di2 = new Range("di2",1,1);
//        
//        List<Range> listOfRanges_di = new ArrayList<Range>();
//        listOfRanges_di.add(di1);
//        listOfRanges_di.add(di2);
//
//        String name_di = "dataconsistency";
//        String unit_di = "bool";
//        
//        QoRMetric metric_di = new QoRMetric(name_di, unit_di, listOfRanges_di);
//        listOfQoRMetrics.add(metric_di);
//        
//        
//        // throughput metric
//        
...
//        MetricRange metricRange14 = new MetricRange("dataconsistency", "di1");
...
//        MetricRange metricRange24 = new MetricRange("dataconsistency", "di1");
...
//        MetricRange metricRange34 = new MetricRange("dataconsistency", "di2");
...
//        MetricRange metricRange44 = new MetricRange("dataconsistency", "di2");
...
//        MetricRange metricRange54 =  new MetricRange("dataconsistency", "di2");
...
//    }
//    
//    public MetricElasticityProcess sampleEPDataConsistency(){
//         List<MetricCondition> listOfMetricConditions = new ArrayList<MetricCondition>();
//        
//        MetricCondition m1 = new MetricCondition("dataconsistency","c14", 0, 0);
//        MetricCondition m2 = new MetricCondition("dataconsistency","c24", 1, 1);
//        
//       
//        listOfMetricConditions.add(m1);
//        listOfMetricConditions.add(m2);
...
//        /// MetricElasticityProcess - datacompleteness
//        
//        String metricName_d = "dataconsistency";
//        MonitoringAction monitorAction_d = new MonitoringAction("dataconsistencyMeasurement");
//        List<MetricControlActions> listOfTriggerActions_d = new ArrayList<MetricControlActions>();
//        
//        
//             
...
//        List<ControlAction> listOfControlActions_d_1 = new ArrayList<ControlAction>();
//        
//        String ca_name_d_1_1 = "T24";     
//        List<Parameter> listOfParameters_d_1_1 = new ArrayList<Parameter>();
//        Parameter param_d_1_1_1 = new Parameter("attributeIndex", "Time", "1");
//        listOfParameters_d_1_1.add(param_d_1_1_1);
//        ControlAction ca_d_1_1 = new ControlAction(ca_name_d_1_1, listOfParameters_d_1_1);    
//        listOfControlActions_d_1.add(ca_d_1_1);
//       
//        
//        MetricControlActions tr_d_1 = new MetricControlActions("c14", "c24", listOfControlActions_d_1);
//        listOfTriggerActions_d.add(tr_d_1);
//        
//    
//     
...
//        MonitoringAction monitorAction_d = new MonitoringAction("throughputMeasurement");
//        List<MetricControlActions> listOfTriggerActions_d = new ArrayList<MetricControlActions>();
//        
//        
//             
...
//        MetricElasticityProcess consistency = sampleEPDataConsistency();
//        
//        
...
//        listOfMetricElasticityProcesses.add(consistency);
//        
//        
