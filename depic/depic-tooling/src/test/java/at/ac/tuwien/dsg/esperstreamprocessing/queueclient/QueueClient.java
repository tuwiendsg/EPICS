        ...
        try {
            ...
            if (message instanceof MapMessage) {
                ...
                while (fieldsNames.hasMoreElements()) {
                    ...
                    DataAsset da = JAXBUtils.unmarshal(data, DataAsset.class);
                    
                    System.out.println("data revceived: " + da.getListOfDataItems().get(0).getListOfAttributes().get(0).getAttributeValue());
