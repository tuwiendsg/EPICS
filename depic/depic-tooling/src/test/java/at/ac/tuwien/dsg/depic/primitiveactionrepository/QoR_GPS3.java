...
public class QoR_GPS3 {
    ...
    public QoRModel sampleQoRModel() {
     ...
     private  List<QoRMetric> sampleListOfQoRMetrics(){
        ...
        Range tr1 = new Range("throughput_co1", 0, 300);
        Range tr2 = new Range("throughput_co2",  301, Double.MAX_VALUE);
        
     
     
        List<Range> listOfRanges_tr = new ArrayList<Range>();
        listOfRanges_tr.add(tr1);
        listOfRanges_tr.add(tr2);
 

        String name_tr = "throughput";
        String unit_tr = "das/s";
        
        QoRMetric metric_tr = new QoRMetric(name_tr, unit_tr, listOfRanges_tr);
        listOfQoRMetrics.add(metric_tr);
    ...
    private  List<QElement> sampleListOfQElements(){
        ...
        listOfMetricRanges1.add("throughput_co2");
        ...
        listOfMetricRanges2.add("throughput_co1");
        double price2=0.005;
        ...
        listOfMetricRanges3.add("throughput_co2");
        double price3=0.007;
        ...
        listOfMetricRanges4.add("throughput_co2");
        double price4=0.008;
        ...
        listOfMetricRanges5.add("throughput_co2");
        double price5=0.006;
