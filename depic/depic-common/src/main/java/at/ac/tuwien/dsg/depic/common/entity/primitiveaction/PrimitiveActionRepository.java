...
public class PrimitiveActionRepository {
    ...
    public PrimitiveActionRepository() {
    }

    public PrimitiveActionRepository(List<ControlAction> listOfControlActions, List<MonitoringAction> listOfMonitoringActions) {
