...
public class PrimitiveActionMetadataManager {
    ...
    public DeployAction getPrimitiveAction(String actionName){
        ...
        try {
            while (rs.next()) {
                ...
                String artifact = rs.getString("ArtifactName"); 
                String type = rs.getString("Type"); 
                String restapi = rs.getString("RESTfulAPI"); 
    ...
    public List<MonitoringAction> getMonitoringActionList() {
        ...
        List<MonitoringAction> listOfActions = new ArrayList<MonitoringAction>();
    ...
    public List<AdjustmentAction> getAdjustmentActionList() {
        ...
        List<AdjustmentAction> listOfActions = new ArrayList<AdjustmentAction>();
    ...
    public List<String> getPrerequisiteActions(String actionName){
        ...
        List<String> listOfPrerequisteActions = new ArrayList<String>();
    ...
    public List<ResourceControlAction> getResourceControlActionList() {
        ...
        List<ResourceControlAction> listOfActions = new ArrayList<ResourceControlAction>();
