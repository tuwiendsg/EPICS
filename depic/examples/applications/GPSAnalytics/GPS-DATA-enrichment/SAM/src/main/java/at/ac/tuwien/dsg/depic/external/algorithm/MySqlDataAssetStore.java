...
public class MySqlDataAssetStore {
    ...
    public String getDataPartition(String dataAssetID, String dataPartitionID){
        ...
        String fileName = dataAssetID + ".data";

        at.ac.tuwien.dsg.depic.common.utils.IOUtils iou = new at.ac.tuwien.dsg.depic.common.utils.IOUtils("/Volumes/DATA/BigData/mydb2");
        String daXML = iou.readData(fileName);
