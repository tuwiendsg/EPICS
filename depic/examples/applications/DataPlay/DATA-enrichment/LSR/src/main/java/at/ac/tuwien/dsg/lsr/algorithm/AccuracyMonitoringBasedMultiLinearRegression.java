 ...
 * @author Jun
 */
public class AccuracyMonitoringBasedMultiLinearRegression {
    ...
    public AccuracyMonitoringBasedMultiLinearRegression() {
        attributeIndex = 1;
        thresholdAlpha = 5;
        thresholdBeta = 10;
        noOfSegments = 3;
    ...
    public AccuracyMonitoringBasedMultiLinearRegression(int attributeIndex, double threshold, int noOfSegments) {
        this.attributeIndex = attributeIndex;
        this.thresholdAlpha = threshold;
        this.noOfSegments = noOfSegments;
    }

    public double monitor(DataAsset dataAsset) {
        ...
        for (int s = 0; s < noOfSegments; s++) {
            ...
            for (int i = 0; i < listOfDataItems.size(); i++) {
                ...
                if (isNumeric(dataAttributeY.getAttributeValue())) {
                    ...
                    if (y != 0) {
                        ...
                        if (Math.abs(y_i - y) > thresholdAlpha) {
                            outlier++;
                        }
            ...
            double accuracy = 100 - outlier * 1.0 / validObjCounter * 100;
            avgAccuracy += accuracy;
        }
        
        avgAccuracy /= noOfSegments;
        return avgAccuracy;
    }
