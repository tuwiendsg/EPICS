...
public class test3 {
    ...
    public static void main(String[] args) throws JAXBException {
        ...
        DataAnalyticFunctionCep daf = new DataAnalyticFunctionCep("chw_supply_temp", dafInputCep, dafOutputCep, dafAnalyticCep, analyticResultDelegate);
        
        
        String xml = JAXBUtils.marshal(daf, DataAnalyticFunctionCep.class);
        
        IOUtils.writeData(xml, "chw_supply_temp");
    ...
    public static DafAnalyticCep sampleAnalytic(){
        ...
        String epl = "select * from SensorEvent match_recognize ( measures A as val1 pattern (A) define A as A.value < 13 and A.name ='chw_supply_temp')";
