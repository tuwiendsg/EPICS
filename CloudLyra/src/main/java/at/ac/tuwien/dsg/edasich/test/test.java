...
public class test {
    ...
    public static void main(String[] args) throws JAXBException {
        ...
        DataAnalyticFunctionCep daf = new DataAnalyticFunctionCep("fcu_ff1_set_point", dafInputCep, dafOutputCep, dafAnalyticCep, analyticResultDelegate);
        
        
        String xml = JAXBUtils.marshal(daf, DataAnalyticFunctionCep.class);
        
        IOUtils.writeData(xml, "fcu_ff1_set_point");
    ...
    public static DafAnalyticCep sampleAnalytic(){
        ...
        String epl = "select * from SensorEvent match_recognize ( measures A as val1 pattern (A) define A as A.value > 21 and A.name ='fcu_ff1_set_point')";
